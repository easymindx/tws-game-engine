...
declare namespace Exitgames.Common {
  export class Logger {
    ...
    static setExceptionHandler(
      handler: (n: number, s: string) => boolean
    ): void;
    /**
...
declare namespace Photon {
  ...
  export class PhotonPeer {
    ...
    /**
        ...
        */
    constructor(
      protocol: Photon.ConnectionProtocol,
      address: string,
      subprotocol?: string,
      debugName?: string
    );
...
declare namespace Photon.LoadBalancing {
  ...
  interface CreateIfNotExistsRoomOptions
    extends CreateIfNotExistsRandomRoomOptions {
    lobbyName?: string;
    lobbyType?: number;
  }
  ...
  export class LoadBalancingClient {
    ...
    joinRoom(
      ...
      createOptions?: CreateIfNotExistsRoomOptions
    ): boolean;
