  ...
  var PhotonPeer = /** @class */ (function () {
    ...
    PhotonPeer.prototype._ping = function (syncServerTime) {
      ...
      this._send(
        ((_a = {}),
        (_a['irq'] = 1),
        (_a['vals'] = [1, Date.now() - this.initTimestamp]),
        _a),
        true
      );
    };
  ...
  (function (LoadBalancing) {
    ...
    var Actor = /** @class */ (function () {
      ...
      Actor.prototype._updateFromResponse = function (vals) {
        ...
        var props =
          vals[LoadBalancing.Constants.ParameterCode.PlayerProperties];
        if (props !== undefined) {
        ...
        if (this.emptyRoomLiveTime != emptyRoomLiveTime) {
          if (
            this.setProp(
              ...
              Photon.TypeExt.Int(
                emptyRoomLiveTime
              ) /*, TypeExt.Int(this.emptyRoomLiveTime)*/
            )
          )
        ...
        if (this.suspendedPlayerLiveTime != suspendedPlayerLiveTime) {
          if (
            this.setProp(
              ...
              Photon.TypeExt.Int(
                suspendedPlayerLiveTime
              ) /*, TypeExt.Int(this.suspendedPlayerLiveTime)*/
            )
          )
            // No CAS by design, also expected = 0 is not supported by server currently
    ...
    var LoadBalancingClient = /** @class */ (function () {
      ...
      LoadBalancingClient.prototype.reconnectToMaster = function () {
        if (
          this.state != LoadBalancingClient.State.Disconnected &&
          this.state != LoadBalancingClient.State.Error
        ) {
          this.logger.warn(
      ...
      LoadBalancingClient.prototype.reconnectAndRejoin = function () {
        ...
        this.changeState(LoadBalancingClient.State.Disconnected);
        return this.connectToGameServer(
      ...
      LoadBalancingClient.prototype.fillCreateRoomOptions = function (
        ...
        if (options.customGameProperties !== undefined) {
          for (var p in options.customGameProperties) {
            Photon.TypeExt.PutTypedKey(
              gp,
              Photon.TypeExt.String(p),
              options.customGameProperties[p]
            );
          }
        }
        op.push(gamePropKey, gp);
        op.push(
          LoadBalancing.Constants.ParameterCode.CleanupCacheOnLeave,
          true
        ...
        if (options.expectedUsers)
          op.push(
            ...
            Photon.TypeExt.String(options.expectedUsers)
          );
      };
      /**
      ...
      LoadBalancingClient.prototype.fillJoinRandomRoomOptions = function (
        op,
        options
      ) {
        if (options) {
      ...
      /**
                ...
                @returns {boolean} If the operation will be sent (requires connection to Master Server).
            */
      LoadBalancingClient.prototype.joinRandomOrCreateRoom = function (
        options,
        createRoomName,
        createOptions
      ) {
        ...
        this.fillCreateRoomOptions(
          op,
          createOptions,
          LoadBalancing.Constants.ParameterCode.Properties
        );
        this.logger.info(
      ...
      LoadBalancingClient.prototype.initGamePeer = function (gp, masterOpCode) {
        ...
        gp.addEventListener(
          LoadBalancing.Constants.EventCode.AuthEvent,
          function (data) {
        ...
        gp.addEventListener(
          LoadBalancing.Constants.EventCode.ErrorInfo,
          function (data) {
            gp._logger.debug('ev ErrorInfo', data);
            _this.onServerErrorInfo(
              data.vals[LoadBalancing.Constants.ParameterCode.Info]
            );
          }
        );
      };
  ...
  (function (Chat) {
    ...
    //            @borrows Photon.LoadBalancing.LoadBalancingClient#connectToNameServer // overrides with connectToNameServer with different parameters
      ...
      /**
            ...
            */
      ChatClient.prototype.onPrivateMessage = function (
        channelName,
        message
      ) {};
      /**
      ...
      /**
            ...
            */
      ChatClient.prototype.onUserUnsubscribe = function (
        channelName,
        userId
      ) {};
      /**
